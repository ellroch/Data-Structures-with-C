...
/*----------------------------------------------------------Init_node()
 initialize node: set default values
 input: node*
 Output: Void
 note: Will break for pointers or strings
------------------------------------- */
 template<class TYPE>
...
/*----------------------------------------------------------init_node<string>()
same as above ^ but for string data types
------------------------------------- */
template<>
void init_node<string>(node<string>* newNode){
  newNode->next=NULL;
  newNode->data="";
}
/*----------------------------------------------------------init_list()
